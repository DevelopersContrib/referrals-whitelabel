          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12">
                <h1 className="capitalize font-bold text-3xl mb-4">
                ...
                <p className="mb-4 text-muted">
                  By using the Referrals.com site you are agreeing to comply
                ...
                <p className="mb-4 text-muted">
                  Referrals.com does not make any guarantees or warranties as to
                  the accuracy of the content and profiles or messages.
                  Referrals.com is not liable for any inaccuracies on the site
                  content and you are using the site at your own risk.
                  Referrals.com is for informational purposes only and provided
                  “as is“ without any warranties or guarantees. By using this
                  site you are agreeing to hold Referrals.com harmless from any
                  harm, loss, damage or injury resulting or arising from your
                  usage of the Referrals.com site.
                </p>
                <h2 className="uppercase font-bold text-xl mb-4">
                  Modifications to this Terms of Use
                </h2>
                <p className="mb-4 text-muted">
                  Referrals.com reserves the right at its sole discretion to
                  change, amend or update this terms of use. It is your
                  responsibility to review the Terms of Use for any updates. And
                  by using this site signifies consent to the right of
                  Referrals.com to change such Terms of Use.
                </p>
                <p className="mb-4 text-muted">
                  Referrals.com and its contributors are not liable for
                  incidental, special, punitive, consequential or exemplary
                  damages of any kind, including, without limitation, loss of
                  business, lost revenues or profits, or loss of data in any way
                  related to the Referrals.com site or for any loss or injury or
                  claim based on interruptions, errors, omissions, or other
                  inaccuracies on the Referrals.com site. You agree to
                  ...
                  apply to you. These limitations shall apply to the fullest
                ...
                <p className="mb-4 text-muted">
                  By submitting Content to us or by posting comments or
                  information on your profile, you are granting or warrant that
                  the owner has express granted, to Referrals.com us a
                  perpetual, irrevocable, royalty-free, and transferable right
                  and license to use and distribute and create derivative works.
                  We may exercise this grant in any platform, media or
                  technology for the full term of any copyright that may exist
                  in such content. You are also hereby granting other affiliates
                  of Referrals.com the rights to use such content in a similar
                  fashion.{" "}
                </p>
                <h2 className="uppercase font-bold text-xl mb-4">
                ...
                <p className="mb-4 text-muted">
                  {" "}
                  Referrals.com has not reviewed and are not responsible for the
                  content and actions of any of the sites that Referrals.com
                  links to nor do we make any warranties to the accuracy and/or
                  safety of using such sites or vendors or products and
                ...
                <p className="mb-4 text-muted">
                  ...
                  nontransferable, revocable, limited license to access and use
                  this Web Site and Content in accordance with these Terms of
                  Use. Provider may terminate this license at any time for any
                  reason.{" "}
                </p>
                <p className="mb-4 text-muted">
                  {" "}
                  The Content on is for your personal use only and not for
                  commercial exploitation. You may not decompile, reverse
                  engineer, disassemble, rent, lease, loan, sell, sublicense, or
                  create derivative works from this Web Site or the Content. Nor
                  may you use any network monitoring or discovery software to
                  determine the site architecture, or extract information about
                  ...
                  otherwise export or re-export this Web Site or any portion
                  thereof, or the Content in violation of the export control
                  laws and regulations of the United States of America. Any
                  unauthorized use of this Web Site or its Content is
                  prohibited.{" "}
                </p>
                <p className="mb-4 text-muted">
                  {" "}
                  Nothing submitted to Referrals.com is treated as confidential.
                  The accuracy, completeness, adequacy or currency of the
                  Content is not warranted or guaranteed. Your use of Content on
                  this Web Site or materials linked from this Web Site is at
                  your own risk.{" "}
                </p>
                <p className="mb-4 text-muted">
                  {" "}
                  Referrals.com may contain advertising and sponsorship.
                ...
                <p className="mb-4 text-muted">
                  {" "}
                  The Referrals.com site AND THE CONTENT ARE PROVIDED ON AN “AS
                  IS, AS AVAILABLE” BASIS. PROVIDER EXPRESSLY DISCLAIMS ALL
                  WARRANTIES, INCLUDING THE WARRANTIES OF MERCHANTABILITY,
                  FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.
                  PROVIDER DISCLAIMS ALL RESPONSIBILITY FOR ANY LOSS, INJURY,
                  CLAIM, LIABILITY, OR DAMAGE OF ANY KIND RESULTING FROM,
                  ARISING OUT OF OR ANY WAY RELATED TO (A) ANY ERRORS IN OR
                  OMISSIONS FROM THIS WEB SITE AND THE CONTENT, INCLUDING, BUT
                  NOT LIMITED TO, TECHNICAL INACCURACIES AND TYPOGRAPHICAL
                  ERRORS, (B) ANY THIRD PARTY CONTENT INCLUDING BUT NOT LIMITED
                  TO ANY ERRORS IN OR OMISSIONS THEREFROM, (C) THE
                  UNAVAILABILITY OF THIS WEB SITE OR ANY PORTION THEREOF, (D)
                  YOUR USE OF THIS WEB SITE OR THE CONTENT, OR (E) YOUR USE OF
                  ANY EQUIPMENT OR SOFTWARE IN CONNECTION WITH THIS WEB SITE.{" "}
                </p>
                <h2 className="uppercase font-bold text-xl mb-4">
                ...
                <p className="mb-4 text-muted">
                  {" "}
                  Referrals.com SHALL NOT BE LIABLE FOR ANY LOSS, INJURY, CLAIM,
                  LIABILITY, OR DAMAGE OF ANY KIND RESULTING FROM YOUR USE OF
                  ...
                  your own risk. We do not have any involvement with the parties
                  or businesses who use this site nor their dealings or any
                  interactions.{" "}
                </p>
                <p className="mb-4 text-muted">
                  {" "}
                ...
                <p className="mb-4 text-muted">
                  {" "}
                  Minors are not allowed to use Referrals.com and The provisions
                  of paragraphs “Disclaimer” and “Limitation of Liability”, are
                  for the benefit of Referrals.com and its employees and/or
                  contractors and any third party information providers to this
                  Web Site. Each of these individuals or entities shall have the
                  right to assert and enforce those provisions directly against
                  you on its own behalf.{" "}
                </p>
                <p className="mb-4 text-muted">
                  {" "}
                  Referrals.com reserves the right to investigate complaints or
                  reported violations of our Terms of Use and to take any action
                ...
                <p className="mb-4 text-muted">
                  {" "}
                  Referrals.com reserves the right to seek all remedies
                  ...
                  from a particular internet address to this Web Site and any
                  other Provider web sites and their features.{" "}
                </p>
                <p className="mb-4 text-muted">
                  {" "}
                  The Terms of Use are governed by and construed in accordance
                  with the laws of the State of Delaware and any action arising
                  out of or relating to these terms shall be filed only in state
                  or federal courts located in Delaware and you hereby consent
